...
To compare the models we will choose as our metric the $F_1$ score given by:

$${F_1} = 2\frac{{{\rm{precision}} \times {\rm{recall}}}}{{{\rm{precision}} + {\rm{recall}}}}$$

We can [write](https://www.scipy-lectures.org/packages/scikit-learn/index.html#supervised-learning-classification-of-handwritten-digits) a `for` loop that does the following:
...
cross_val_comparison(models_list,X_train,X_test,y_train,y_test)
